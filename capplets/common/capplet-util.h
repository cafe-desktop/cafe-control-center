...
void capplet_help (CtkWindow *parent, char const *section);
void capplet_set_icon (CtkWidget *window, char const *icon_file_name);
gboolean capplet_file_delete_recursive (GFile *directory, GError **error);
gboolean capplet_dialog_page_scroll_event_cb (CtkWidget *widget, CdkEventScroll *event, CtkWindow *window);
